                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('uploads/products/'.$product->image) }}"
                                                ...
                                                <td>
                                                    <input data-id="{{$product->id}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Active" data-off="Suspend" {{ $product->status ? 'checked' : '' }}>
                                                </td>
                                            <td> &#8377;{{ $product->price }}</td>
                                            <td>
                                                <div class="dropdown">
